            ...
            <div className="bg-web3 max-w-screen-xl  w-full z-20 top-0 left-0 text-white">
                <div className="flex flex-col md:flex-row max-w-screen-xl w-[94%] items-center justify-between mx-auto pt-5 pb-5">
                    <div className="md:w-1/2 p-4 order-2 md:order-2 text-center md:text-center ">
                        ...
                        <p className="text-sm md:text-sm lg:text-lg mt-9 mb-6">MangoSwap is your gateway to decentralized trading and liquidity provision. It's a user-friendly decentralized exchange where you can swap, stake, and yield farm various cryptocurrencies.
                        </p>
