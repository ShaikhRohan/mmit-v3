            ...
            <div className="bg-blockchain max-w-screen-xl  w-full z-20 top-0 left-0 text-white">
                <div className="flex flex-col md:flex-row max-w-screen-xl w-[94%] items-center justify-between mx-auto  pt-5 pb-5">
                    <div className="md:w-1/2 p-4 order-2 md:order-1 text-center md:text-center ">
                        ...
                        <p className="text-sm md:text-sm lg:text-lg mt-9">MangoWallet is your secure and user-friendly wallet solution for managing your degital assets. It provides a convenient way to store, send, and receive various cryptocurrencies while maintaining security and privacy
