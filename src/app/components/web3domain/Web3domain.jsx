...
export default function Web3doamin() {
    return (
        <>
            <div id="web3" className="bg-web3 max-w-screen-xl  w-full z-20 top-0 left-0 text-white mt-20">
                <div className="flex flex-col md:flex-row max-w-screen-xl w-[94%] items-center justify-between mx-auto  pt-5 pb-5">
                    <div className="md:w-1/2 p-4 order-2 md:order-2 text-center md:text-center  ">
                        ...
                        <p className="text-sm md:text-sm lg:text-lg mt-9 lowercase">
                            WE HAVE ADOPTED IN JULY 2023 AS OF NOW THERE ARE 85K+ DOMAINS HAVE BEEN REGISTERED MAKING MMIT MORE POWERFUL BECAUSE EACH DOMAIN CONTAINS <a className="mangocolor cursor-default">.MMIT EXTENSION</a> 
                        </p>
                        ...
                        <p className="text-sm md:text-sm lg:text-lg mt-9">
                            Explore the endless possibilities of the web with Web3 - it's your domain, your money, and your digital legacy, all in one! Don't forget to take a look at this amazing revolution. Check it out right now. </p>
                    ...
                    <div className="md:w-1/2  md:order-1 flex justify-center">
                        <Image width={"100%"} height={"100%"} src={imgMangoTree} alt="heroimg" />
                    </div>
                </div>
            </div>
