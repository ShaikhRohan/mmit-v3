                    ...
                    <div className="mx-auto w-full max-w-screen-xl">
                        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <ul className="text-white  font-medium">
                                    <li className="mb-4 footerli">
                                        <a href="https://t.me/mangomanintell" className="hover:underline">
                                            Telegram
                                        </a>
                                    </li>
                                    <li className="mb-4 footerli">
                                        <a href="https://twitter.com/mangomanintell" className="hover:underline">
                                            Twitter
                                        </a>
                                    </li>
                                    <li className="mb-4 footerli">
                            ...
                            <div className='w-[80%]'>
                                ...
                                <h2 className="mb-4 mt-2 text-sm text-center font-semibold text-white uppercase ">
                                    Scan QR code for Mango Wallet App.
                                </h2>
                                {/* <ul className="text-white  font-medium">
                        ...
                        <div style={{ borderTop: '1px solid gray' }} className="px-4 py-6 bg-transparent  md:flex md:items-center md:justify-between">
                            <span className="text-sm text-white  sm:text-center">
                                © 2023 <a className='mangoname' href="">Mango</a> All Rights
                                Reserved.
                            </span>
